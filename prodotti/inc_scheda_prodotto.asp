...
if pkid_prod>0 then
  ...
  if FkCategoria_1>0 then
    ...
    if cat_rs.recordcount>0 then
      ...
      Else
        Url_Cat_1="/categorie/inc_categorie_1.asp?cat_1="&FkCategoria_1
      end if
    end if
    cat_rs.close
  end if
  ...
  if FkCategoria_2>0 then
    ...
    if sot_rs.recordcount>0 then
      ...
      if Len(Url_Cat_2)>0 then
        Url_Cat_2="/categorie/"&Url_Cat_2
      Else
        Url_Cat_2="/categorie/inc_categorie_2.asp?cat_2="&FkCategoria_2
      end if
    end if
    sot_rs.close
  end if
                    ...
                    <div class="top-buffer">
                        <div class="top-buffer">
                            ...
                            <div class="row">
                                ...
                                img_thumb="http://www.buggyrc.it/public/thumb/"&NoLettAcc(img_rs("File"))
                                img_zoom="http://www.buggyrc.it/public/"&NoLettAcc(img_rs("Zoom"))
                        ...
                        <table id="cart" class="table table-hover table-condensed table-cart">
                            ...
                            <tbody>
                                ...
                                img_thumb="http://www.buggyrc.it/public/thumb/"&NoLettAcc(var_rs("Img"))
                                img_zoom="http://www.buggyrc.it/public/"&NoLettAcc(var_rs("Img"))
                                pezzi=var_rs("Pezzi")
