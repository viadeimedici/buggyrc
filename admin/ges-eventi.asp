...
if ordine=0 then ord="Eventi.PkId DESC"
if ordine=1 then ord="Eventi.Titolo_1 ASC"
if ordine=2 then ord="Eventi.Titolo_1 DESC"
        ...
        <!--tab centrale-->
			<table width="740" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr class="intestazione col_primario"> 
                <td width="43%"><a href="<%=pag_elenco%>?ordine=0">Cod.</a>&nbsp;Titolo menù&nbsp;<a href="<%=pag_elenco%>?ordine=1">A/Z</a>&nbsp;<a href="<%=pag_elenco%>?ordine=2">Z/A</a></td>
                <td width="38%">Titolo esteso</td>
