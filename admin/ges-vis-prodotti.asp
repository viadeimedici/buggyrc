...
<%
pag_elenco="ges-vis-prodotti.asp"
                ...
                <td colspan="2">&nbsp;</td>
             	...
             	<%
					  	...
					  	Do While Not nrs.EOF
								...
								'sql = sql + "AND ((Data>='10/23/2017 00:00:00') And (Data<='10/23/2017 23:59:59'))"
								if mode=1 then sql = sql + "AND ((Data>='"&mm_i&"/"&gg_i&"/"&aa_i&" 00:00:00') And (Data<='"&mm_f&"/"&gg_f&"/"&aa_f&" 23:59:59'))"
